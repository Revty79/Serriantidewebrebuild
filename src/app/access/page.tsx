  ...
  return (
    <main className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
      <section className="w-full max-w-6xl">
        ...
        {denied && <p role="alert" className="mt-6 text-center text-amber-200">Your account does not have access to that area. Choose one of your available paths below.</p>}
