      ...
      <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
            {summaryCards.map((card) => (
              ...
              >
                ...
                <p className="mt-3 text-xl text-amber-200">{summary.availability[card.key] ? summary.counts[card.key] : "Not available yet"}</p>
              </article>
            ))}
          </div>
        </section>
        ...
        <div className="mt-8 grid gap-6 xl:grid-cols-2">
          <RecordSection
            ...
            count={summary.counts.campaignsCreated} available={summary.availability.campaignsCreated}
          ...
          <RecordSection
            ...
            count={summary.counts.campaignsJoined} available={summary.availability.campaignsJoined}
          ...
          <RecordSection
            ...
            count={summary.counts.playerCharacters} available={summary.availability.playerCharacters}
          ...
          <RecordSection
            ...
            count={summary.counts.raceNpcsControlled} available={summary.availability.raceNpcsControlled}
          ...
          <RecordSection
            ...
            count={summary.counts.creatureNpcsControlled} available={summary.availability.creatureNpcsControlled}
      ...
      <div className="pt-5">
        {count > 0 ? (
          ...
          <p className="rounded-xl border border-dashed border-white/10 px-4 py-5 text-sm text-slate-400">
            {available ? emptyMessage : "This system is not available in the rebuild yet."}
          </p>
        )}
      </div>
    </details>
